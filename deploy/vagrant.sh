...
if [[ ! -f ${INSTALL_HOME}/php.lock ]]; then
    ...
    apt-get install -yf php5;
    apt-get install -yf libapache2-mod-php5;
    apt-get install -yf php5-cli;
    apt-get install -yf php5-gd;
    apt-get install -yf php5-json;
    apt-get install -yf php5-ldap;
    apt-get install -yf php5-mysql;
    #apt-get install -y php5-pgsql;
    apt-get install -yf php5-curl;
    print_footer;
fi;
